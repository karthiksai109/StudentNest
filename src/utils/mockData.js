...
const SPORTS_BY_CITY = {
  Austin: [
    ...
    { name: 'Austin Badminton Club', sport: 'Badminton', level: 'All Levels', address: 'Gregory Gym, 2101 Speedway, Austin, TX 78712', distance: '0.3', fee: '$5/session', schedule: 'Tue/Thu 7:00 PM', members: 65, equipmentProvided: true, image: SPORTS_IMAGES.badminton, contact: { name: 'Austin Badminton Club', phone: null, email: 'austinbadminton@gmail.com' }, events: [{ name: 'Doubles Tournament', date: 'Sat, Nov 15', participants: 32 }] },
    { name: 'Longhorn Basketball Pickup', sport: 'Basketball', level: 'Recreational', address: 'RecSports Center, 2001 San Jacinto Blvd, Austin, TX 78712', distance: '0.4', fee: 'Free for students', schedule: 'Daily 6:00 PM', members: 150, equipmentProvided: true, image: SPORTS_IMAGES.basketball, contact: { name: 'UT RecSports', phone: '(512) 471-1093', email: 'recsports@utexas.edu' }, events: [{ name: '3v3 Tournament', date: 'Sat, Nov 1', participants: 36 }] },
    { name: 'Penick-Allison Tennis Center', sport: 'Tennis', level: 'Beginner Friendly', address: 'Penick-Allison Tennis Center, 2100 Red River St, Austin, TX 78712', distance: '0.6', fee: 'Free for students', schedule: 'Mon/Wed 4:00 PM', members: 45, equipmentProvided: false, image: SPORTS_IMAGES.tennis, contact: { name: 'UT Tennis Club', phone: null, email: 'tennisclub@utexas.edu' }, events: [{ name: 'Beginner Clinic', date: 'Sat, Oct 25', participants: 16 }] },
    { name: 'Lady Bird Lake Running Group', sport: 'Running', level: 'All Levels', address: 'Ann & Roy Butler Hike-and-Bike Trail, Austin, TX 78704', distance: '1.8', fee: 'Free', schedule: 'Tue/Thu/Sat 6:30 AM', members: 90, equipmentProvided: false, image: SPORTS_IMAGES.running, contact: { name: 'ATX Runners', phone: null, email: 'atxrunners@gmail.com' }, events: [{ name: 'Austin 5K Prep Run', date: 'Sat, Nov 8', participants: 40 }] },
    { name: 'UT Table Tennis Club', sport: 'Table Tennis', level: 'All Levels', address: 'Gregory Gym Room 36, 2101 Speedway, Austin, TX 78712', distance: '0.3', fee: 'Free for students', schedule: 'Mon/Wed/Fri 6:00 PM', members: 55, equipmentProvided: true, image: SPORTS_IMAGES.tabletennis, contact: { name: 'UT Table Tennis', phone: null, email: 'uttabletennis@gmail.com' }, events: [{ name: 'Singles Championship', date: 'Sat, Nov 22', participants: 24 }] },
    { name: 'Zilker Park Volleyball', sport: 'Volleyball', level: 'Recreational', address: 'Zilker Park Sand Courts, 2100 Barton Springs Rd, Austin, TX 78704', distance: '3.5', fee: 'Free', schedule: 'Weekends 10:00 AM', members: 70, equipmentProvided: true, image: SPORTS_IMAGES.volleyball, contact: { name: 'Zilker Volleyball', phone: null, email: 'zilkervolley@gmail.com' }, events: [{ name: 'Beach Volleyball Tourney', date: 'Sun, Nov 2', participants: 28 }] },
    { name: 'UT Yoga & Wellness', sport: 'Yoga', level: 'Beginner Friendly', address: 'RecSports Center Studio, 2001 San Jacinto Blvd, Austin, TX 78712', distance: '0.4', fee: 'Free for students', schedule: 'Tue/Thu 7:30 AM', members: 60, equipmentProvided: true, image: SPORTS_IMAGES.yoga, contact: { name: 'UT RecSports', phone: '(512) 471-1093', email: 'recsports@utexas.edu' }, events: [{ name: 'Sunrise Yoga Session', date: 'Sat, Oct 25', participants: 20 }] },
    { name: 'Gregory Gym Lap Swimming', sport: 'Swimming', level: 'All Levels', address: 'Gregory Gym Pool, 2101 Speedway, Austin, TX 78712', distance: '0.3', fee: 'Free for students', schedule: 'Daily 6:00 AM - 9:00 PM', members: 40, equipmentProvided: false, image: SPORTS_IMAGES.swimming, contact: { name: 'UT RecSports', phone: '(512) 471-1093', email: 'recsports@utexas.edu' }, events: [{ name: 'Lap Swim Challenge', date: 'Fri, Nov 14', participants: 15 }] },
  ],
  'New York': [
    { name: 'NYC Cricket Club', sport: 'Cricket', level: 'All Levels', address: 'Van Cortlandt Park Cricket Field, Bronx, NY 10471', distance: '8.0', fee: '$10/month', schedule: 'Sat/Sun 9:00 AM', members: 95, equipmentProvided: true, image: SPORTS_IMAGES.cricket, contact: { name: 'NYC Cricket Club', phone: null, email: 'nyccricket@gmail.com' }, events: [{ name: 'Fall League Finals', date: 'Sat, Nov 8', participants: 44 }] },
    { name: 'NYU Intramural Soccer', sport: 'Soccer', level: 'Recreational', address: 'Pier 40, 353 West St, New York, NY 10014', distance: '0.8', fee: 'Free for students', schedule: 'Mon/Wed 6:00 PM', members: 72, equipmentProvided: true, image: SPORTS_IMAGES.soccer, contact: { name: 'NYU RecSports', phone: '(212) 998-2020', email: 'athletics@nyu.edu' }, events: [{ name: 'Intramural Match', date: 'Wed, Oct 29', participants: 22 }] },
    { name: 'Manhattan Badminton Club', sport: 'Badminton', level: 'All Levels', address: 'Palladium Athletic Facility, 140 E 14th St, New York, NY 10003', distance: '0.3', fee: '$8/session', schedule: 'Tue/Thu 8:00 PM', members: 50, equipmentProvided: true, image: SPORTS_IMAGES.badminton, contact: { name: 'Manhattan Badminton', phone: null, email: 'nycbadminton@gmail.com' }, events: [{ name: 'Open Tournament', date: 'Sat, Nov 15', participants: 28 }] },
    { name: 'Central Park Running Club', sport: 'Running', level: 'All Levels', address: 'Central Park Engineers Gate, 90th St & 5th Ave, New York, NY 10128', distance: '4.0', fee: 'Free', schedule: 'Tue/Thu/Sat 6:30 AM', members: 120, equipmentProvided: false, image: SPORTS_IMAGES.running, contact: { name: 'CP Running Club', phone: null, email: 'cprunclub@gmail.com' }, events: [{ name: 'NYC Marathon Training Run', date: 'Sat, Nov 1', participants: 55 }] },
    { name: 'Chelsea Piers Basketball', sport: 'Basketball', level: 'Recreational', address: 'Chelsea Piers, Pier 62, New York, NY 10011', distance: '1.5', fee: '$15/session', schedule: 'Daily 5:00 PM', members: 80, equipmentProvided: true, image: SPORTS_IMAGES.basketball, contact: { name: 'Chelsea Piers', phone: '(212) 336-6100', email: 'info@chelseapiers.com' }, events: [{ name: '3v3 Tourney', date: 'Sat, Nov 8', participants: 36 }] },
  ],
  'Los Angeles': [
    { name: 'UCLA Cricket Club', sport: 'Cricket', level: 'All Levels', address: 'UCLA Intramural Field, 630 Westwood Plaza, Los Angeles, CA 90095', distance: '0.3', fee: 'Free for students', schedule: 'Sat/Sun 9:00 AM', members: 65, equipmentProvided: true, image: SPORTS_IMAGES.cricket, contact: { name: 'UCLA Cricket Club', phone: null, email: 'uclacricket@gmail.com' }, events: [{ name: 'SoCal Cricket Cup', date: 'Sat, Nov 8', participants: 40 }] },
    { name: 'Westwood Soccer League', sport: 'Soccer', level: 'Recreational', address: 'Stoner Park, 1835 Stoner Ave, Los Angeles, CA 90025', distance: '1.2', fee: 'Free', schedule: 'Mon/Wed/Fri 5:30 PM', members: 90, equipmentProvided: true, image: SPORTS_IMAGES.soccer, contact: { name: 'Westwood Soccer', phone: null, email: 'westwoodsoccer@gmail.com' }, events: [{ name: 'League Match', date: 'Wed, Oct 29', participants: 22 }] },
    { name: 'Santa Monica Yoga on the Beach', sport: 'Yoga', level: 'Beginner Friendly', address: 'Santa Monica Beach, 1550 Pacific Coast Hwy, Santa Monica, CA 90401', distance: '6.0', fee: 'Free', schedule: 'Sat/Sun 7:00 AM', members: 75, equipmentProvided: true, image: SPORTS_IMAGES.yoga, contact: { name: 'Beach Yoga SM', phone: null, email: 'beachyoga@gmail.com' }, events: [{ name: 'Sunrise Beach Yoga', date: 'Sat, Oct 25', participants: 30 }] },
    { name: 'UCLA Wooden Center Swimming', sport: 'Swimming', level: 'All Levels', address: 'John Wooden Center, 221 Westwood Plaza, Los Angeles, CA 90095', distance: '0.2', fee: 'Free for students', schedule: 'Daily 6:00 AM - 10:00 PM', members: 50, equipmentProvided: false, image: SPORTS_IMAGES.swimming, contact: { name: 'UCLA Recreation', phone: '(310) 825-3701', email: 'recreation@recreation.ucla.edu' }, events: [{ name: 'Lap Swim Challenge', date: 'Fri, Nov 14', participants: 18 }] },
    { name: 'Venice Beach Basketball', sport: 'Basketball', level: 'Competitive', address: 'Venice Beach Courts, 1800 Ocean Front Walk, Venice, CA 90291', distance: '8.0', fee: 'Free', schedule: 'Daily 4:00 PM', members: 100, equipmentProvided: false, image: SPORTS_IMAGES.basketball, contact: { name: 'Venice Hoops', phone: null, email: 'venicehoops@gmail.com' }, events: [{ name: 'King of the Court', date: 'Sat, Nov 1', participants: 32 }] },
  ],
}
